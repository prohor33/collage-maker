...
//			if (make_collage_task == null || make_collage_task.isCancelled()) {
			    ...
			    adView.setAdUnitId(getResources().getString(R.string.my_ad_block_id));
...
//			}
			mHandler.postDelayed(this, (long)(10000 + Math.random()*5000));
		}
	};	
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mHandler.postDelayed(mUpdateTimeTask, (long)(5000 + Math.random()*5000));
